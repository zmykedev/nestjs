...
export class CreateInitialTables1700000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // Crear tabla de autenticación (para login y sesiones)
    await queryRunner.createTable(
      new Table({
        name: 'auth_sessions',
        columns: [
    ...
    // Crear índices optimizados para consultas frecuentes usando SQL directo
    ...
    // Índices compuestos para libros
    await queryRunner.query(
      'CREATE INDEX IDX_BOOKS_TITLE_ACTIVE ON books (title, is_active)',
    );
    await queryRunner.query(
      'CREATE INDEX IDX_BOOKS_GENRE_ACTIVE ON books (genre_id, is_active)',
    );
    await queryRunner.query(
      'CREATE INDEX IDX_BOOKS_PUBLISHER_ACTIVE ON books (publisher_id, is_active)',
    );
    ...
    await queryRunner.query(
      'CREATE INDEX IDX_AUTHORS_DELETED ON authors (deleted_at)',
    );
    ...
    await queryRunner.query(
      'CREATE INDEX IDX_GENRES_DELETED ON genres (deleted_at)',
    );

    // Índices para editoriales
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX IDX_PUBLISHERS_DELETED ON publishers (deleted_at)',
    );

    // Índices para relaciones libro-autor
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX IDX_BOOK_AUTHORS_DELETED ON book_authors (deleted_at)',
    );

    // Índices para sesiones de autenticación
    await queryRunner.query(
    ...
    await queryRunner.query(
      'CREATE INDEX IDX_AUTH_SESSIONS_DELETED ON auth_sessions (deleted_at)',
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE books DROP CONSTRAINT IF EXISTS FK_BOOKS_GENRE',
    );
    await queryRunner.query(
